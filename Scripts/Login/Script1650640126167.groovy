...
WebUI.setText(findTestObject('Object Repository/Page_TestProject Demo/input_Full Name_name'), 'mark')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_TestProject Demo/input_Password_password'), 'iGDxf8hSRT4=')

WebUI.sendKeys(findTestObject('Object Repository/Page_TestProject Demo/input_Password_password'), Keys.chord(Keys.ENTER))
